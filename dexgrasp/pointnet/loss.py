...
class ChamferDistance_Scaled(nn.Module):

    def __init__(self):
        super(ChamferDistance_Scaled, self).__init__()
    ...
    def forward(self, x, y, scale):
        ...
        distance_scaled = (min_for_each_x_i.sum(1) + min_for_each_y_j.sum(1)) * scale**2  # shape [b]
        return distance_scaled.mean(0)
