...
class DAGGER:
    ...
    def __init__(self,
        ...
        if self.is_vision_expert: self.expert_observation_space = self.observation_space
        else: self.expert_observation_space = spaces.Box(np.ones(300) * -np.Inf, np.ones(300) * np.Inf)
